...
const Registro = () => {
  ...
  // Datos reales de regiones y comunas de Chile
  const regionesComunas = {
    ...
    "vi": [
      "Rancagua", "Machalí", "Graneros", "Codegua", "San Francisco de Mostazal",
      "Rengo", "San Fernando", "Santa Cruz", "Pichilemu", "Navidad", "Litueche",
      "La Estrella", "Marchihue", "Paredones", "Palmilla", "Peralillo", "Placilla",
      "Pumanque", "Chépica", "Nancagua", "Palmilla", "Peralillo", "Placilla"
    ],
    "vii": [
  ...
  const handleChange = (e) => {
    ...
    // Si cambia la región, actualizar las comunas disponibles
    if (id === "region") {
      setComunas(regionesComunas[value] || []);
      setFormData(prev => ({ ...prev, comuna: "" })); // Resetear comuna al cambiar región
    }
  };
